...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    public static void updatePlantWidgets(Context context, AppWidgetManager manager, int imgRes, int[] appWidgetIds){
        for (int appWidgetId : appWidgetIds) {
            updateAppWidget(context, manager, imgRes, appWidgetId);
        }
    }
